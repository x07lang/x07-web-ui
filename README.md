...
| **Stdlib package** (`packages/std-web-ui/0.2.5/`) | Canonical `std.web_ui.*` modules (tree, event, patch, effect, telemetry, builder-I/O helpers, and Tactics M0 audio/haptics device helpers) |
...
- Recommended install flow:
  ...
  - `x07 pkg add std-web-ui@0.2.5 --sync`
- Package publish line: `std-web-ui@0.2.5`
